export default {
  CafesAndBakeries: [
    {
      label: 'Small Victory Bakery',
      lat: 49.25859334438221, 
      lng: -123.13873378462311,
    ...
    },
    {
      ...
      desc: 'Vintage corner store with decent coffee and surprisingly good food!'
    },
    {
      label: 'Blenz Coffee',
    ...
    },
    {
      ...
      desc: "Excellent all 'round!"
    },
    {
      label: 'Bean Around the World',
      lat: 49.26229920410998, 
      lng: -123.12239976920426,
      desc: 'Unique drinks such as beet ginger latte'
    },
    {
      label: 'Beaucoup Bakery',
      lat: 49.266577777753184, 
      lng: -123.14072383936174,
      desc: "Must try their hot cocoa. It's really rich!"
    },
    {
      label: 'Blue Hat Bakery',
      lat: 49.269950803986944, 
      lng: -123.1375628476882,
      desc: 'Chefs in training serve up really good pastry, coffee and a wicked hot cocoa!'
    },
    {
      label: 'Pallet Coffee Roasters',
      lat: 49.26359654012127, 
      lng: -123.15079629443129,
      desc: 'Damn good coffee!'
    },
    {
      label: 'Platform 7 Coffee',
      lat: 49.263775532222375, 
      lng: -123.15784109770138,
      desc: 'Cool setting, great lunch sandwiches!'
    },
    {
      label: 'Thomas Haas Chocolatier',
      lat: 49.26423878286061, 
      lng: -123.16335139396156,
      desc: 'Awesome hot cocoa!'
    },
    {
      label: "Juliet's Cafe",
      lat: 49.272637404600964, 
      lng: -123.14803722438617,
      desc: 'Really good grilled chicken sandwich'
    },
    {
      label: 'Cafe Zen',
      lat: 49.27117000256656, 
      lng: -123.1552107186119,
      desc: 'Lots of variety on the menu, and an excellent French toast!'
    },
    {
      label: 'Viva Fine Foods & Bakery',
      lat: 49.27209581182346, 
      lng: -123.15513496061445,
      desc: 'Excellent matcha latte and premium quality sandwiches, pastry and cookies!'
    },
    {
      label: 'Blue Parrot',
      lat: 49.27267772878422, 
      lng: -123.13540418428299,
      desc: 'A nice relaxing place with decent food and coffee, and an awesome view of Burrard Bridge. Try their foccacia sandwiches!'
    },
    {
      label: 'Our Town Cafe',
      lat: 49.26301729616128, 
      lng: -123.09992144343515,
      desc: 'Interesting corner setting with good coffee and food!'
    },
    {
      label: 'Thierry Chocolatier Mt Pleasant',
      lat: 49.26211593765953, 
      lng: -123.0998495944646,
      desc: 'Excellent sandwich and soup combo'
    },
    {
      label: 'Milano Coffee Roasters',
      lat: 49.263843350098405, 
      lng: -123.10870006392572,
      desc: 'Lots of coffee varieties with a nice vista of the park and city skyline'
    },
    {
      label: 'Terra Breads',
    ...
    },
    {
      ...
      desc: 'Interesting drinks: try their organic ginger chai latte!'
    },
    {
    ...
    },
    {
      ...
      desc: 'Coffee always excellent, even their decaf!'
    },
    {
    ...
    {
      label: "Delany's Coffee House",
      lat: 49.28880225601423, 
      lng: -123.14067179719922,
      desc: 'Good brew and food options'
    },
    {
      label: 'Nemesis Coffee',
      lat: 49.267165496929685, 
      lng: -123.09262535975738,
      desc: 'Damn good pastry!'
    },
    {
      label: "Kafka's Coffee",
      lat: 49.26731951686064, 
      lng: -123.09043667723262,
      desc: 'Cozy little nook with a split-level setting'
    },
    {
      label: 'Prado Cafe',
      lat: 49.26948726431933, 
      lng: -123.14096826463485,
      desc: 'Decent coffee and sandwiches'
    },
    {
      label: 'Bel Cafe',
      lat: 49.26889460146715, 
      lng: -123.14511524160119,
      desc: 'Nice buzzing cafe with interesting baguettes!'
    },
    {
      label: 'Elysian Coffee',
      lat: 49.26710490942158, 
      lng: -123.1451392861762,
      desc: 'Decent coffee'
    },
    {
      label: 'Enroute Bike Shop/Cafe',
      lat: 49.270940220925645, 
      lng: -123.15540973986501,
      desc: 'Little off-the-grid cafe with nice coffee and pastry'
    },
    {
      label: 'Breka Bakery & Cafe',
      lat: 49.26865677880061, 
      lng: -123.18680232801866,
      desc: 'Good coffee, pastry and dessert, open 24/7'
    },
    {
      label: 'Grounds for Coffee',
      lat: 49.26400888306555, 
      lng: -123.1861604529745,
      desc: 'Known for their cinnamon buns'
    },
    {
      label: 'The Birds and the Beets',
    ...
    {
      label: 'Cafe Villagio',
      lat: 49.29127980949542, 
      lng: -123.12787067961791,
      desc: 'Nice place to sit for a while near Coal Harbour'
    },
    {
      label: 'Beyond Coffee',
      lat: 49.280840035645525, 
      lng: -123.12702363473483,
      desc: 'Makes an awesome breakfast English egg muffin'
    },
    {
      label: 'Modus Coffee',
      lat: 49.262966314468116, 
      lng: -123.10725579393409,
      desc: 'Cozy, little cafe with good coffee and food'
    },
    {
      label: 'Paragon Tea Room',
      lat: 49.265707433214104, 
      lng: -123.115086846949,
  ...
  JuiceBars: [
    {
      label: 'Heirloom Juice Company',
      lat: 49.26023473372165, 
      lng: -123.13890175291127,
    },
  ],

  Restaurants: [
    {
      label: 'Cafe Salade de Fruits',
      lat: 49.265883970898535, 
      lng: -123.14023339089486,
    },
  ],
  ...
  Brunch: [
    {
      ...
      lat: 49.2586136391187, 
      lng: -123.13836640566382,
    },
    {
      label: "Paul's Omelettery",
      lat: 49.26605356028349, 
      lng: -123.13870705522214,
    },
  ],

  Vegetarian: [
    {
      label: 'Lotus Seed Vegan',
      lat: 49.263204656918624, 
      lng: -123.12105219497737,
    },
  ],
  ...
  Burgers: [
    {
      label: "Triple O's",
      lat: 49.273433857625655, 
      lng: -123.14717797537452,
    },
  ],

  PubsBars: [
    {
      label: "Carlos O'Bryan's Neighbourhood Pub",
      lat: 49.26537928857413, 
      lng: -123.1453758096267,
    },
  ],
  ...
  Parks: [
    {
      label: 'Douglas Park',
      lat: 49.2525429003053, 
      lng: -123.12330565030788,
    },
  ],
};
